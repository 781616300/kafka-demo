...
public class GpKafkaConsumer extends Thread{
    ...
    public GpKafkaConsumer(String topic) {
        ...
        properties.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,"172.24.29.12:9092,172.24.29.13:9092,172.24.29.14:9092");
        properties.put(ConsumerConfig.CLIENT_ID_CONFIG,"gp-consumer");
        properties.put(ConsumerConfig.GROUP_ID_CONFIG,"gp-gid3");
